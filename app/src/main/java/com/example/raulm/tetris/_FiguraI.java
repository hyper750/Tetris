...
public class _FiguraI extends _Figura {
    public _FiguraI(View view, TetrisObject tetris) {
        super(view, tetris);
    }
    ...
    protected Drawable setDrawable() {
        ...
        figurai.setIntrinsicWidth(_Figura.TAMANY_QUADRAT);
        figurai.setIntrinsicHeight(_Figura.TAMANY_QUADRAT*4);
        return figurai;
    }
