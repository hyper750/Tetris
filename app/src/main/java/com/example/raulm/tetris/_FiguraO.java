...
public final class _FiguraO extends _Figura {
    public _FiguraO(View view, TetrisObject tetris) {
        super(view, tetris);
    }
    ...
    1f, 0 seria que ocupa 100% des tamany assignat de x que seria _Figura.TAMANY_QUADRAT*2, dos quadrats
    ...
    protected Drawable setDrawable(){
        ...
        figura_o.setIntrinsicWidth(_Figura.TAMANY_QUADRAT*2);
        figura_o.setIntrinsicHeight(_Figura.TAMANY_QUADRAT*2);
        return figura_o;
    }
